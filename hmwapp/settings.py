"""
Django settings for hmwapp project.
...
SECRET_KEY = 'django-insecure-y1davuu)@*o&#wtl9%%a4x6r3u$_^09ezku_&6(4dz=ckl5o^g'
...
AUTHENTICATION_BACKENDS = [
    ...
    'health_monitorapp.authentication.CustomUserBackend',
]
